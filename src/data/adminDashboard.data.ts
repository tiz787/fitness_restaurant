...
export const dashboardMetrics: DashboardMetric[] = [
  { id: 'ventas', icon: '$', value: '$1823', label: 'Ventas hoy', badge: '+12%', tone: 'success' },
  { id: 'pedidos', icon: '[]', value: '4', label: 'Pedidos hoy', badge: '+8%', tone: 'info' },
  { id: 'ticket', icon: '->', value: '$456', label: 'Ticket promedio', badge: '+3%', tone: 'warning' },
  {
    id: 'activos',
    icon: 'CL',
    value: '3',
...
export const salesTrendData: SalesTrendPoint[] = [
  { day: '04-12', amount: 5000 },
  { day: '04-13', amount: 5200 },
  { day: '04-14', amount: 4600 },
  { day: '04-15', amount: 6400 },
  { day: '04-16', amount: 7200 },
  { day: '04-17', amount: 8600 },
  { day: '04-18', amount: 9000 },
  { day: '04-19', amount: 5600 },
]
...
export const topDishesData: TopDish[] = [
  { id: 'dish-1', name: 'Acai Power Bowl', orders: 3, revenue: '$555' },
  { id: 'dish-2', name: 'Green Detox Smoothie', orders: 3, revenue: '$335' },
  { id: 'dish-3', name: 'Power Chicken Bowl', orders: 1, revenue: '$264' },
  { id: 'dish-4', name: 'Salmon Mediterraneo', orders: 1, revenue: '$245' },
  { id: 'dish-5', name: 'Meal Prep Box Semanal', orders: 1, revenue: '$699' },
]
...
export const promotionCouponsData: PromotionCoupon[] = [
  ...
  },
  {
    id: 'coupon-03',
    code: 'ENVIOGRATIS',
    title: 'Envio gratis en pedidos mayores a $300',
  ...
  },
  {
    id: 'coupon-04',
    code: 'PROTEINA50',
    title: '$50 de descuento en pedidos de volumen',
    description: 'Promocion enfocada en clientes con alto ticket.',
    discountType: 'fixed-amount',
    discountValue: 50,
    currentUses: 100,
    maxUses: 100,
    expiresOn: '31/03/2025',
    status: 'Inactivo',
    conditions: {
      minOrderTotal: 400,
      takeoutOnly: false,
...
export const managedUsersData: ManagedUser[] = [
  {
    ...
    isNewThisMonth: true,
    orders: [
      { id: 'ORD-807394', dateLabel: '18/04/2026', total: '$200', status: 'En camino' },
      { id: 'ORD-001', dateLabel: '12/04/2026', total: '$549', status: 'Entregado' },
      { id: 'ORD-221', dateLabel: '05/04/2026', total: '$332', status: 'Entregado' },
    ],
  },
  {
    id: 'user-02',
    ...
    isNewThisMonth: true,
    orders: [
      { id: 'ORD-004', dateLabel: '17/04/2026', total: '$629', status: 'Entregado' },
      { id: 'ORD-190', dateLabel: '02/04/2026', total: '$278', status: 'Entregado' },
    ],
  },
  {
    id: 'user-03',
    ...
    orders: [
      { id: 'ORD-145', dateLabel: '07/04/2026', total: '$188', status: 'Entregado' },
      { id: 'ORD-146', dateLabel: '10/03/2026', total: '$240', status: 'Cancelado' },
    ],
  },
  {
    id: 'user-04',
    ...
    role: 'Cliente',
    isNewThisMonth: false,
    orders: [{ id: 'ORD-003', dateLabel: '18/04/2026', total: '$445', status: 'Preparando' }],
  },
  {
    id: 'user-05',
    ...
    isNewThisMonth: true,
    orders: [
      { id: 'ORD-005', dateLabel: '16/04/2026', total: '$425', status: 'Entregado' },
      { id: 'ORD-080', dateLabel: '29/03/2026', total: '$206', status: 'Entregado' },
      { id: 'ORD-049', dateLabel: '12/03/2026', total: '$285', status: 'Entregado' },
    ],
  },
  {
    id: 'user-06',
    ...
    isNewThisMonth: true,
    orders: [
      { id: 'ORD-099', dateLabel: '14/04/2026', total: '$152', status: 'Entregado' },
      { id: 'ORD-042', dateLabel: '01/02/2026', total: '$198', status: 'Entregado' },
    ],
  },
]
...
const reportWeekRevenueValues = [8400, 9100, 7600, 12400, 13700, 15900, 16300, 7400]
...
const reportMonthRevenueValues = [
  9800, 10200, 10700, 9950, 11100, 11600, 10950, 12200, 12600, 13200, 12400, 13600, 14100,
  14500, 13800, 14900, 15300, 15800, 16200, 15500, 16400, 16800, 8400, 9100, 7600, 12400,
  13700, 15900, 16300, 7400,
]
...
const reportYearRevenueValues = [
  255000, 268000, 281000, 382400, 396000, 412000, 431000, 438000, 421000, 447000, 462000,
  489000,
]
...
const reportCategoryPerformanceByPreset: Record<ReportPresetFilter, CategoryPerformanceData[]> = {
  Semana: [
    { category: 'Almuerzo', revenue: 45000, color: '#4aa157' },
    { category: 'Cena', revenue: 31000, color: '#63b768' },
    { category: 'Desayuno', revenue: 22000, color: '#7fce86' },
    { category: 'Smoothies', revenue: 11000, color: '#9adfa3' },
    { category: 'Snacks', revenue: 5000, color: '#e68a3b' },
  ],
  Mes: [
    { category: 'Almuerzo', revenue: 188000, color: '#4aa157' },
    { category: 'Cena', revenue: 133000, color: '#63b768' },
    { category: 'Desayuno', revenue: 91000, color: '#7fce86' },
    { category: 'Smoothies', revenue: 46000, color: '#9adfa3' },
    { category: 'Snacks', revenue: 24000, color: '#e68a3b' },
  ],
  Año: [
    { category: 'Almuerzo', revenue: 2180000, color: '#4aa157' },
    { category: 'Cena', revenue: 1560000, color: '#63b768' },
    { category: 'Desayuno', revenue: 1010000, color: '#7fce86' },
    { category: 'Smoothies', revenue: 548000, color: '#9adfa3' },
    { category: 'Snacks', revenue: 384000, color: '#e68a3b' },
  ],
}
